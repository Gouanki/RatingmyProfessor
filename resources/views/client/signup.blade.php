          ...
          <div class="hero-static content content-full px-1">
            <div class="row mx-0 justify-content-center">
              <div class="col-lg-8 col-xl-6">
                ...
                <!-- Sign Up Form -->
                <form action="{{ url('/create_student') }}" class="js-validation-signup" method="POST">
                    {{ csrf_field() }}
                    ...
                    <div class="block-content">
                      <div class="form-floating mb-4">
                        ...
                        class="form-control @error('name')
                           is-invalid
                        @enderror" placeholder="Enter your user name">
                    @error('name')
                ...
                @enderror"
                    ...
                    @enderror
                      ...
                      <div class="form-floating mb-4">
                        <select class="form-select form-select-lg @error('university') is-invalid
                         @enderror"
                        name="university" id="university">
                        <option selected value="null">Select a University</option>
                        @foreach ($universities as $university)
                            <option value="{{ $university->id }}">{{ $university->university_name }}
                            </option>
                        @endforeach
                    </select>
                    @error('university')
                ...
                <div class="block block-rounded shadow-none mb-0">
                  ...
                  <div class="block-content fs-sm">
                    ...
                    <p class="text-justify">
                        ...
                        site. Though you have the option of creating an account, an account is not required to post a rating
                        and comment. Whether you choose to create a registered account or not, all ratings submitted will
                        remain anonymous.
                    </p>
