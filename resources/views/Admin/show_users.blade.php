                        ...
                        <tbody>
                            ...
                            @foreach ($students as $student)
                                <tr>
                                    ...
                                    <td class="fw-semibold">{{ $student->university->university_name }}</td>
                                    <td class="fw-semibold">{{ $student->email }}</td>
                                    <td class="fw-semibold">{{$student->type}}</td>
                                    <td class="d-none d-sm-table-cell text-center">
                                        <a href="{{ url('/edit_user_role/' . $student->id) }}" class="btn btn-info">
                                            <i class="fa-solid fa-pen"></i></a>
                                        <a data-bs-toggle="modal" data-bs-target="#modal-popin"
                                            data-id="{{ $student->id }}" data-name="{{ $student->student_name }}"
            ...
            <script>
                $(document).ready(function() {
                    $('.btn-danger').click(function() {
                        ...
                        var url = "{{ url('delete_student/') }}/" + studentId;
