                        ...
                        <tbody>
                            ...
                            @foreach ($ratings as $rating)
                                <tr>
                                    ...
                                    <td>
                                        @if (isset($rating->course->course_name))
                                            {{ $rating->course->course_name }}
                                        @else
                                            {{ $rating->course_name }}
                                        @endif
                                    </td>
                                    <td class="d-none d-sm-table-cell">{{ $rating->comment }}</td>
                                    ...
                                    <td class="d-none d-sm-table-cell text-center">
                                        @if ($rating->status == 0)
                                            <a href="{{ url('/active_prof_comment/' . $rating->id) }}"
                                                class="btn btn-success"><i class="fa-solid fa-thumbs-up"></i></a>
                                        @else
                                            <a href="{{ url('/disable_prof_comment/' . $rating->id) }}"
            ...
            <script>
                $(document).ready(function() {
                    $('.btn-danger').click(function() {
                        ...
                        var url = "{{ url('delete_professor_comment/') }}/" + commentId;
