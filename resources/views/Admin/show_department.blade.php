                    ...
                    <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                        <thead>
                            <tr>
                                ...
                                <th>Name</th>
                                <th class="d-none d-sm-table-cell">created date</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($departments as $department)
                                <tr>
                                    ...
                                    <td class="d-none d-sm-table-cell">{{$department->created_at}}</td>
                                    <td class="d-none d-sm-table-cell text-center">
                                        <a href="{{url('/edit_department/'.$department->id)}}" class="btn btn-primary"><i class="fa-solid fa-pen"></i></a>
            ...
            <script>
                $(document).ready(function() {
                    $('.btn-danger').click(function() {
                        ...
                        var url = "{{ url('delete_department/') }}/" + studentId;
