                        ...
                        <tbody>
                            ...
                            @foreach ($professors as $professor)
                                <tr>
                                    ...
                                    <td class="fw-semibold">{{ $professor->professor_name }}</td>
                                    <td class="d-none d-sm-table-cell">{{ $professor->department->department_name }}</td>
                                    <td class="d-none d-sm-table-cell">{{ $professor->university->university_name }}</td>
                                    <td class="d-none d-sm-table-cell text-center">
                                        <a href="{{ url('/edit_professor/' . $professor->id) }}" class="btn btn-primary"><i
                                                class="fa-solid fa-pen"></i></a>
                                                <a data-bs-toggle="modal" data-bs-target="#modal-popin"
                                                data-id="{{ $professor->id }}" data-name="{{ $professor->professor_name }}"
    ...
    <script>
        $(document).ready(function() {
            $('.btn-danger').click(function() {
                ...
                var url = "{{ url('delete_professor/') }}/" + studentId;
